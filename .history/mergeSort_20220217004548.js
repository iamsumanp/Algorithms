...
const mergeSort = (arr, left, right) => {
  ...
  if (left < right) {
    ...
    mergeSort(arr, left, middle); //for sorting left subArray after the base condition  is false it goes to next line sorting the left subArray

    mergeSort(arr, middle + 1, right); // for sorting right subArray after base condition is false
